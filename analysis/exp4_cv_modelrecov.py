...
def exp4_cv_modelrecov(n_folds=5, cv_seed=0, fakedataset_modelfullname_combidx = 0):
    ...
    filename = os.path.join(data_path, "exp4_fits_fakedata_allmodels")
        ...
        for include_offset_param in [include_offset_param_vals]:
            for model_idx in [0]:
                ...
                for subj in range(n_subj): # Just Subject 0.
                    ...
                    filename = os.path.join(fits_path, "exp4_fits_cv_modelrecov_temp__d_"+fake_dataset_genmodel+"__m_"+model_fullname)
                ...
                # Save fitted model
                filename = os.path.join(fits_path, "exp4_fits_cv_modelrecov__d_"+fake_dataset_genmodel+"__m_"+model_fullname)
...
exp4_cv_modelrecov(n_folds, cv_seed, fakedataset_modelfullname_combidx)