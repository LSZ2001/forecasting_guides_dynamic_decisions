...
def exp3(cross_validate=0, n_folds=5, cv_seed=0, modelfullname_combidx = 0):
    ...
    for include_offset_param in [include_offset_param_vals]:
        for model_idx in [0]:
            ...
            for subj in range(n_subj): # Just Subject 0.
                ...
                if(cross_validate):
                    filename = os.path.join(fits_path, "exp3_fits2_cv_temp__d_human__m_"+model_fullname)
                    ...
                    filename = os.path.join(fits_path, "exp3_fits2_temp__d_human__m_"+model_fullname)
            ...
            # Save fitted model
            if(cross_validate):
                filename = os.path.join(fits_path, "exp3_fits2_cv__d_human__m_"+model_fullname)
                ...
                filename = os.path.join(fits_path, "exp3_fits2__d_human__m_"+model_fullname)
...
exp3(cross_validate, n_folds, cv_seed, modelfullname_combidx)